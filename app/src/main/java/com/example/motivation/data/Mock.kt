...
class Mock {
    ...
    private val langEn = MotivationConstantes.LANGUAGE.ENGLISH
    private val langPt = MotivationConstantes.LANGUAGE.PORTUGUESE
    private val langFr = MotivationConstantes.LANGUAGE.FRENCH
